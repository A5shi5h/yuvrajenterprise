  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-slate-700 via-slate-800 to-slate-700 shadow-lg z-50 p-2">
      <div className="max-w-7xl mx-auto px-4 lg:px-10 py-4 flex justify-between items-center text-lg font-semibold">
        {/* Logo */}
        <Link href="/">
          <h1 className="text-white font-light">Yuvraj Enterprise</h1>
        </Link>

        {/* Desktop Menu */}
        <div className="hidden md:flex space-x-8 font-thin text-sm">
          <Link href="/" className="text-white hover:text-slate-500">
            Home
          </Link>
          <Link href="/about" className="text-white hover:text-slate-500">
            About Us
          </Link>
          ...
          <div className="relative">
            <button
              ...
              className="text-white hover:text-slate-500 flex items-center"
            >
